...
[React](https://react.org) is a great libary created by facebook. It Helps us build ui faster. When people learning or new to new to development often get stuck or get fustrated with all the overwhealming
...
> [CRA](https://github.com/facebook/create-react-app) is command that will
> create a dev environment for you with neccery tools. Its documentation is good enough
> to learn reactjs.
...
<br />> **Note:** Every source is good but you need to choose one that is good for
you.
