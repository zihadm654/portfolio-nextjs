    ...
    <section className='about__page'>
      ...
      >
        ...
        <h3>
          ...
          telling stories visually, through <span>minimalistic </span> and clear
          way. I design and develop <span>responsive websites </span>and
      ...
      <div className='principle'>
        ...
        <div className='content'>
          ...
          <article>
            <h5>Grid System</h5>
            <p>
              I use mostly grid system. <span>Grid system</span> is a way which
              can make your design so much clean and align can be so much
              perfect. I use the <span>12 grid.</span> So, it helps me to divide
              the design into<span> 3 parts.</span>
            </p>
          </article>
          <article>
            ...
            <p>
              ...
              way i can be consistent with design and make work easier. And most
              importantly this approach can save time{' '}
          ...
          <article>
            ...
            <p>
              ...
              small parts. Simpilicity is the king in every aspect of our life.{' '}
              <span>small components</span> saves a lot of time and make work
              more productive.
            </p>
          </article>
        </div>
